...
def main():
    dirname = './images/receipts/'
    files = os.listdir(dirname)
    for file_one in files:
        file_out = dirname + file_one.split('.')[0] + '_ret.' + file_one.split('.')[1]
        file_in = dirname + file_one
        print('file name in:{}, file name out:{}'.format(file_in, file_out))
